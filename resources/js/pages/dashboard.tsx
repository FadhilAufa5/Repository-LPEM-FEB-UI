        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto p-6">
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                    ...
                    <div className="rounded-xl border border-sidebar-border/70 bg-white p-6 shadow-sm lg:col-span-2 dark:border-sidebar-border dark:bg-neutral-900">
                        <h3 className="mb-4 text-lg font-bold text-gray-900 dark:text-white">
                        ...
                        {recentRepositories.map((repo) => (
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <h4 className="line-clamp-1 font-semibold text-gray-900 group-hover:text-yellow-600 dark:text-white dark:group-hover:text-yellow-400">
                                        {repo.title}
                                    </h4>
