...
export default function Users() {
    ...
    const handleSearch = (value: string) => {
        ...
        router.get(
            '/users',
            { search: value, role: roleFilter !== 'all' ? roleFilter : undefined, status: statusFilter !== 'all' ? statusFilter : undefined },
    ...
    const handleRoleFilter = (value: string) => {
        ...
        router.get(
            '/users',
            { search, role: value !== 'all' ? value : undefined, status: statusFilter !== 'all' ? statusFilter : undefined },
            { preserveState: true, preserveScroll: true }
        );
    };
    ...
    const handleStatusFilter = (value: string) => {
        ...
        router.get(
            '/users',
            { search, role: roleFilter !== 'all' ? roleFilter : undefined, status: value !== 'all' ? value : undefined },
            { preserveState: true, preserveScroll: true }
        );
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
                            ...
                            <Button
                                ...
                                onClick={() =>
                                    router.get(
                                        ...
                                        { search, role: roleFilter !== 'all' ? roleFilter : undefined, status: statusFilter !== 'all' ? statusFilter : undefined },
                                        { preserveState: true, preserveScroll: true }
                                    )
                                }
            ...
            <UserDialog open={userDialogOpen} onOpenChange={setUserDialogOpen} user={selectedUser} />
